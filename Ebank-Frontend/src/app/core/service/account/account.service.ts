...
export class AccountService {
  ...
  closeAccount(accountId: number, reason: string): Observable<void> {
    return this.http.put<void>(`${this.apiUrl}/close/${accountId}`, reason, { headers: this.getHeaders() });
  }
  ...
  getAccountById(accountId: number): Observable<Account> {
    return this.http.get<Account>(`${this.apiUrl}/get/${accountId}`, { headers: this.getHeaders() });
  }
}
